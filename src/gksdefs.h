...
#define VFPRINTF (*gks_a_vfprintf_routine)
...
extern void __stdcall GNT(float *, float *, int *);
extern void __stdcall GCNT(float *, float *, int *);
...
extern int __stdcall GORD(int *, int *, int *);
extern int __stdcall GANY(int *, int *, int *);
extern int __stdcall GALL(int *, int *, int *);
extern void __stdcall GADD(int *, int *, int *);
extern void __stdcall GDEL(int *, int *, int *);
extern void __stdcall GINI(int *, int *);
extern void __stdcall GNUM(int *, int *, int *);
extern void __stdcall GKQPA(int *, int [33]);
extern void __stdcall GKSPA(int *, int [33]);
extern void __stdcall GSDT(float [4], float [4]);
extern void __stdcall GPOLIN(int *, float *, float *, int *, int *,
    void (*)(), void (*)());
extern void __stdcall GFILLA(int *, float *, float *, int *, void (*)(),
    float *);
...
extern void __stdcall GQPIX(int *, int *);
extern void __stdcall GSPIX(int *, int *);
extern void __stdcall GKAFM(int *, int *, int *);
extern void __stdcall LOOKUP(int *, int *, int *);
...
void GNT(float *, float *, int *);
void GCNT(float *, float *, int *);
void GCST(float *, float *);
void GCHH(float *);
void GKDCSG(int *, int *, int *, float *, float *, char *, unsigned short);
void GKFVP(float *, float *, float *);
int GORD(int *, int *, int *);
int GANY(int *, int *, int *);
int GALL(int *, int *, int *);
void GADD(int *, int *, int *);
void GDEL(int *, int *, int *);
void GINI(int *, int *);
void GNUM(int *, int *, int *);
void GKQPA(int *, int [33]);
void GKSPA(int *, int [33]);
void GSDT(float [4], float [4]);
void GPOLIN(int *, float *, float *, int *, int *, void (*)(float *, float *),
    void (*)(float *, float *));
void GFILLA(int *, float *, float *, int *,
    void (*)(int *, float *, float *, int *, int *), float *);
void GMOVE(float *, float *, void (*)(float *, float *));
void GDASH(float *, float *, void (*)(float *, float *),
    void (*)(float *, float *));
void GSIMPM(int *, float *, float *, void (*)(float *, float *, int *));
...
extern void (*gks_a_vfprintf_routine)(FILE *file, char *format, ...);
